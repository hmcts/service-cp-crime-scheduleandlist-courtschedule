...
GitHub Releases UI
    │
    │  1. Navigate to:
    │     https://github.com/hmcts/service-cp-crime-scheduleandlist-courtschedule/releases/new
...
ci-build-publish.yml
    ...
    ├── Build             service-cp-crime-scheduleandlist-courtschedule-1.2.6.jar
    ├── Build-Docker      ghcr.io/hmcts/service-cp-crime-scheduleandlist-courtschedule:1.2.6
    ...
    └── deploy-sit
            writes cp-vp-aks-deploy / env/sit / vp-config/services_values.yml:
              service-cp-crime-scheduleandlist-courtschedule.image.tag = "1.2.6_010626"
...
`https://github.com/hmcts/service-cp-crime-scheduleandlist-courtschedule/actions`
